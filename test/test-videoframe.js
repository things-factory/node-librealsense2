...
describe("VideoFrame test", function () {
  ...
  it("Testing property data", () => {
    assert(
      ...
      "[object Uint16Array]" || Object.prototype.toString.call(frame.data),
      "[object Uint8Array]"
    );
  });
  ...
  it("Testing method getData - 0 argument", () => {
    ...
    assert(
      Object.prototype.toString.call(frame.getData()),
      "[object Uint16Array]" || Object.prototype.toString.call(frame.getData()),
      "[object Uint8Array]" || Object.prototype.toString.call(frame.getData()),
      "[object Buffer]"
    );
  });
  ...
  it("Testing method getData - buffer argument", () => {
    ...
    assert(
      ...
      "[object Uint16Array]" || Object.prototype.toString.call(buf),
      "[object Uint8Array]" || Object.prototype.toString.call(buf),
      "[object Buffer]"
    );
  });
